...
import net.iceyleagons.gaia.utils.EarthDistance
import org.springframework.beans.factory.BeanFactory
import kotlin.jvm.optionals.getOrNull
import kotlin.math.abs

/**
 * This detector handles movement-related inconsistencies.
 *
 * @author TOTHTOMI
 * @version 1.0.0
 * @since Oct. 22, 2022
...
class AccountTakeoverDetector : Detector {
    ...
    override fun getScore(userInput: UserInput, context: BeanFactory): Rule {
        ...
        if (currentIpDetailed.countryCode == recentIpDetailed.countryCode &&
            ...
            // Same country, same state, same county. We are likely travelling by car.
